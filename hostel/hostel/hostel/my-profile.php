...
$query="update  userRegistration set regNo=?,firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updationDate=?,profilepic=?,studentid=?,nationid=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisisss',$regno,$fname,$mname,$lname,$gender,$contactno,$udate,$aid,$ppic,$stdid,$ntid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="ppic" id="ppic"  class="form-control" maxlength="10" value="<?php echo $row->profilepic;?>" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Student Id : </label>
<div class="col-sm-8">
<input type="text" name="stdid" id="stdid"  class="form-control" maxlength="10" value="<?php echo $row->studentid;?>" required="required">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="ntid" id="ntid"  class="form-control" maxlength="10" value="<?php echo $row->nationid;?>" required="required">
</div>
</div>
