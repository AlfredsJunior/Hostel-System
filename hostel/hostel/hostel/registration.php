...
<div class="form-group">
	<form action="upload.php" method="post" enctype="multipart/form-data">
	    ...
	    <input type="file" name="ppic" id="ppic" accept="image/*" required=""><br>
...
<div class="form-group">
<label class="col-sm-8 control-label">Confirm Password : </label> <br>
<div class="col-sm-8"> 
...
<button class="btn btn-default" type="">Cancel</button>
