...
<tr>
<td width="12%" valign="top" class="heading">Profile Pic: </td>
<td class="comb-value1"><?php echo $row['ppic'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">Student id: </td>
<td class="comb-value1"><?php echo $row['stdid'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">National id: </td>
<td class="comb-value1"><?php echo $row['ntid'];?></td>
</tr>
...
<tr>
<td width="12%" valign="top" class="heading"> Hometown: </td>
<td class="comb-value1"><?php echo $row['corresCIty'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">County: </td>
...
<tr>
<td width="12%" valign="top" class="heading">Town: </td>
