...
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode,profilepic,studentid,nationid) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssisississsisssisss',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode,$ppic,$stdid,$ntid);
$stmt->execute();
$stmt->close();


$query1="insert into  userregistration(regNo,firstName,middleName,lastName,gender,contactNo,email,password,profilepic,studentid,nationid) values(?,?,?,?,?,?,?,?,?,?,?)";
$stmt1= $mysqli->prepare($query1);
$stmt1->bind_param('sssssisssss',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$contactno,$ppic,$stdid,$ntid);
$stmt1->execute();
...
<div class="form-group">
	<form action="upload.php" method="post" enctype="multipart/form-data">
	    ...
	    <input type="file" name="ppic" accept="image/*" id="ppic" required=""><br>
	 <label class="col-sm-2 control-label"> Student Id:</label>
	    <input type="file" name="stdid" id="stdid" required=""> <br>
	    <label class="col-sm-2 control-label"> National Id:</label>
	    <input type="file" name="ntid" id="ntid" required="">
		</form>
</div>					
