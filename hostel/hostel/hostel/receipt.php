      	   ...
      	   while($row=$res->fetch_object())
      	  {
							...
							<div class="card">
								<div class="card-body m-sm-3 m-md-5">
									<div class="mb-4">
										...
										<br /> This is the receipt for a payment of <strong>Ksh <?php echo $row->feespm;?></strong> you made to Mt. Kenya Hostels.
									</div>

									<div class="row">
										<div class="col-md-6">
											<div class="text-muted">Mobile No.</div>
											<strong><?php echo $row->contactno;?></strong>
										</div>
              ...
              Mt. Kenya Hostel
									...
									<table class="table table-sm">
										...
										<tbody>
											<tr>
												...
												<td class="text-right"><?php echo $row->feespm;?></td>
											</tr>
									...
									<div class="text-center">
										<p class="text-sm">
											<small>Thanks for being loyal to Us. Mt. Kenya Hostels Powered By <a href="https://#">Alfreds Junior</a> <small>This is a system generated receipt</small></small>
										</p>
...
$('body').html(restorepage);
				...
				<button class='btn btn-success' id="print" onclick="printContent('printInvoice');" >Print</button>
